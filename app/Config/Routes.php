...
$routes->get('/web/tambahbarang', 'Web::tambahbarang');
$routes->get('/keranjang', 'Web::keranjang');
$routes->get('/kontak', 'Web::kontak');
$routes->get('/detail/(:any)', 'Web::detail/$1');
$routes->delete('/auth/lihatbarang/(:num)', 'Auth::delete/$1');
